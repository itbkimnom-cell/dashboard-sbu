<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            ...
            @lang('crud.potentials.show_title')
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <x-partials.card class="mt-5">
                ...
                <div class="mt-4 px-4">
                    <a href="{{ route('potentials.index') }}" class="button">
                    ...
                    @endcan @can('delete', $potential)
                    <div class="float-right">
                        <form
                            action="{{ route('potentials.destroy', $potential) }}"
                            method="POST"
